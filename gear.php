...
<html lang="en">
    ...
    <body>
        ...
        <div class="explorer section">
            ...
            <div class="guitar" id="gtrElem">
                <div class="guitarImgContainer">
                    ...
                    <img id="gtrImg" src="img/content/guitars/GtrOutline.svg">
        ...
        <div class="otherJunGear noGtrAbove section" id="otherJunGear">
            ...
            <div class="cabinet">
                <div class="main strip stripDown">
                    <div class="stripBack"></div>
                    <div class="stripText">
                        <h2>Cabinet</h2>
                        <p>Jun typically uses a <b>Soldano 4x12"</b> cabinet in combination with one of his amps.</p>
                    </div>
                    <img data-action="zoom" class="stripImg" src="img/content/extraGear/amps/SoldanoCabinet.jpg">
                </div>
            </div>
